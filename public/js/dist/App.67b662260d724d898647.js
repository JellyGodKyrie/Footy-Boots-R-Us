...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../utilities/boots-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
function NewOrderPage(_ref) {
  ...
  const [menuBoots, setMenuBoots] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]);
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    async function getBoots() {
      const boots = await Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../utilities/boots-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())();
      categoriesRef.current = boots.reduce((cats, boot) => {
        const cat = boot.category.name;
  ...
  /*-- Event Handlers --*/
  async function handleAddToOrder(bootId) {
    const updatedCart = await Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../utilities/orders-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(bootId);
    setCart(updatedCart);
  }
  async function handleChangeQty(bootId, newQty) {
    const updatedCart = await Object(function webpackMissingModule() { var e = new Error("Cannot find module '../../utilities/orders-api'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(bootId, newQty);
    setCart(updatedCart);
  }
  ...
  return /*#__PURE__*/React.createElement("main", {
    ...
    menuBoots: menuBoots.filter(boot => boot.category.name === activeCat),
...
/******/ })()
;
//# sourceMappingURL=App.570891b5d752ec9c732a14e5f21a275a.js.map